...
2. Clone *your forked repository* (e.g., `git clone git@github.com:yourname/at_c_buildimage`)
3. Set your remotes as follows:

   ```sh
   cd REPO
   git remote add upstream git@github.com:atsign-company/at_c_buildimage.git
   ...
   ```text
   origin  git@github.com:yourname/at_c_buildimage.git (fetch)
   origin  git@github.com:yourname/at_c_buildimage.git (push)
   upstream        git@github.com:atsign-company/at_c_buildimage.git (fetch)
...
1. Reset your fork's `main` branch to exactly match upstream `main`:
